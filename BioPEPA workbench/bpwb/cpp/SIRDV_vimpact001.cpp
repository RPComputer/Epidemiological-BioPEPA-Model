...
Vector Propensity (const Vector& ___discreteSpeciesCount, double t)
{
  ...
  /*      infect = [(I*placeholder)/(S+I+R+V)] */
  ___propensity(___infect) = ((I*placeholder)/(S+I+R+V));

  /*      infectcount = [(I*placeholder)/(S+I+R+V)] */
  ___propensity(___infectcount) = ((I*placeholder)/(S+I+R+V));
