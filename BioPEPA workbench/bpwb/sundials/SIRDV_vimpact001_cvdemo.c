...
int main (int argc, char *argv[])
{
    ...
    const realtype alpha_     = def_p_[3];
    realtype def_y_[6] = {RCONST(60000000.0), RCONST(2.0), RCONST(0.0), RCONST(0.0), RCONST(0.0), RCONST(2.0)};
    realtype y_[6];
    realtype p_[4];
    realtype solver_param_[3] = {RCONST(1.0e-6), RCONST(0.0), RCONST(10.0)};
    char *varnames_[6] = {"S_", "I_", "R_", "D_", "V_", "CUMI_"};
    char *parnames_[4] = {"placeholder_", "vaccinerate_", "gamma1_", "alpha_"};
