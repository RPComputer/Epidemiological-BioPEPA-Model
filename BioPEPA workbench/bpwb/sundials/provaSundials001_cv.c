                ...
                N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
    ...
    DENSE_ELEM(jac_, 0, 0) =  readRt(t, "Rt.csv", I_)/pow( R_+S_+I_,2.0)*S_*delta_*I_-readRt(t, "Rt.csv", I_)/( R_+S_+I_)*delta_*I_;
    DENSE_ELEM(jac_, 0, 1) =  readRt(t, "Rt.csv", I_)/pow( R_+S_+I_,2.0)*S_*delta_*I_-readRt(t, "Rt.csv", I_)/( R_+S_+I_)*S_*delta_;
    DENSE_ELEM(jac_, 0, 2) = readRt(t, "Rt.csv", I_)/pow( R_+S_+I_,2.0)*S_*delta_*I_;
    DENSE_ELEM(jac_, 1, 0) = -readRt(t, "Rt.csv", I_)/pow( R_+S_+I_,2.0)*S_*delta_*I_+readRt(t, "Rt.csv", I_)/( R_+S_+I_)*delta_*I_;
    DENSE_ELEM(jac_, 1, 1) = -readRt(t, "Rt.csv", I_)/pow( R_+S_+I_,2.0)*S_*delta_*I_+readRt(t, "Rt.csv", I_)/( R_+S_+I_)*S_*delta_-delta_-gamma1_;
