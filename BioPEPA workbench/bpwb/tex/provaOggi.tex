...
\input{provaOggi_biopepa}
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.6\textwidth]{dot/provaOggi.pdf}
\caption{Reaction network}
\end{center}
\end{figure}
\newpage
\section{Graphs from Bio-PEPA model}
\includegraphics[scale=0.5]{png/provaOggi001_stochkit_results_0}
\hfill
\includegraphics[scale=0.5]{png/provaOggi001_stochkit_results_1}
\appendix
\newpage
\section{Bio-PEPA input file}
\verbatiminput{provaOggi.biopepa}
\newpage
\section{Dizzy equivalent input file}
\verbatiminput{dizzy/provaOggi001.dizzy}
\newpage
\section{PRISM equivalent input file}
\verbatiminput{prism/provaOggi001.sm}
\end{document}
