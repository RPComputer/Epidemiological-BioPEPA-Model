 ...
 *
 *
 *  CVODE ODE solver for the vector field named: time001
 *
 *  This file was generated by the program VFGEN, version: 2.6.0.dev3
 *  Generated on 20-Jul-2022 at 18:52
 *
 */
...
int main (int argc, char *argv[])
{
    ...
    const int N_ = 1;
    const int P_ = 1;
    const realtype def_p_[1] = {
        RCONST(3.5000000000000003e-02)
    };
    const realtype k1_        = def_p_[0];
    realtype def_y_[1] = {RCONST(10000.0)};
    realtype y_[1];
    realtype p_[1];
    realtype solver_param_[3] = {RCONST(1.0e-6), RCONST(0.0), RCONST(10.0)};
    char *varnames_[1] = {"S_"};
    char *parnames_[1] = {"k1_"};
    ...
    flag = CVodeMalloc(cvode_mem, time001_vf, t, y0_, CV_SS, solver_param_[1], &(solver_param_[0]));
    flag = CVodeSetFdata(cvode_mem, &(p_[0]));
    flag = CVDense(cvode_mem, N_);
    flag = CVDenseSetJacFn(cvode_mem, time001_jac, &(p_[0]));
