...
namespace CSE
{
  namespace StochRxn
  {
                             ...
                             const SolverOptions &options)
    {
      ...
      //
      const StepsizeSelectorFunc selectStepsize = options.stepsize_selector_func;
      const SingleStepFunc takeStep = options.single_step_func;
      const StoreStateFunc storeState = options.store_state_func;
