...
//For the simulation
int TotalIte=8; //How many iterations totally need
int NodeIte=1;  //How many iterations each node do once
char ModelName[50] = "HSR"; //for the result
//char MethodName[40]="dimerstats"; //The name of simualtion method
